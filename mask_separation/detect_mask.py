from mask_separation.close_matting import closed_form_matting_with_trimap
...
def make_parser():
    ...
    parser.add_argument('-i','--image', type=str, default='figs/test/source.jpg', help='input image path')
